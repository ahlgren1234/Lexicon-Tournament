        ...
        public static async Task SeedDataAsync(this IApplicationBuilder builder)
        {
            ...
            var tournaments = new List<TournamentDetails>
            {
                new TournamentDetails
                {
                    ...
                    Games = new List<Game>
                    {
                        new Game { Title = "The game nr 1", Time = DateTime.Now.AddDays(31) },
                        new Game { Title = "The Game nr 2", Time = DateTime.Now.AddDays(33) }
                    }
                },
                ...
                new TournamentDetails
                {
                    ...
                    Games = new List<Game>
                    {
                        new Game { Title = "The Game nr 3", Time = DateTime.Now.AddDays(61) },
                        new Game { Title = "The game nr 4", Time = DateTime.Now.AddDays(63) }
                    }
            }
            };
